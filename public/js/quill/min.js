...
!(function (t, e) {
    ...
    return (function (t) {
        ...
        function (t, e, n) {
                                ...
                                value: function (t, e) {
                                    ...
                                    if ("string" != typeof t) {
                                        ...
                                        null == this.imports[t] || r || P.warn("Overwriting " + t + " with", e),
                                            (this.imports[t] = e),
                                            (t.startsWith("blots/") || t.startsWith("formats/")) && "abstract" !== e.blotName ? w.default.register(e) : t.startsWith("modules") && "function" == typeof e.register && e.register();
                                },
                            },
                        ]),
                        h(t, [
            ...
            (S.DEFAULTS = { bounds: null, formats: null, modules: {}, placeholder: "", readOnly: !1, scrollingContainer: null, strict: !0, theme: "default" }),
                (S.events = g.default.events),
                (S.sources = g.default.sources),
                (S.version = "1.3.6"),
                (S.imports = { delta: d.default, parchment: w.default, "core/module": _.default, "core/theme": T.default }),
                (e.expandConfig = l),
                (e.overload = s),
                (e.default = S);
        },
        ...
        function (t, e, n) {
            ...
            (d.events = { EDITOR_CHANGE: "editor-change", SCROLL_BEFORE_UPDATE: "scroll-before-update", SCROLL_OPTIMIZE: "scroll-optimize", SCROLL_UPDATE: "scroll-update", SELECTION_CHANGE: "selection-change", TEXT_CHANGE: "text-change" }),
                        ...
                        s(t, [
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return (
                                        r instanceof Text
                                            ? (s < r.data.length ? (f.setStart(r, s), f.setEnd(r, s + 1)) : (f.setStart(r, s - 1), f.setEnd(r, s), (v = "right")), (b = f.getBoundingClientRect()))
                        ...
                        if (null != a) {
                            ...
                            (s = 0),
                                h.forEach(function (e, i) {
                                    t
                                        ? (a.insertAt(c + s, n.TAB), (s += n.TAB.length), 0 === i ? (r += n.TAB.length) : (o += n.TAB.length))
                                        : e.startsWith(n.TAB) && (a.deleteAt(c + s, n.TAB.length), (s -= n.TAB.length), 0 === i ? (r -= n.TAB.length) : (o -= n.TAB.length)),
                                        (s += e.length + 1);
                                }),
                    ...
                    function e(t, n) {
                        ...
                        return (
                            ...
                            /Firefox/i.test(navigator.userAgent)
                                ? (r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !0 }, u), r.addBinding({ key: e.keys.DELETE }, { collapsed: !0 }, c))
                                : (r.addBinding({ key: e.keys.BACKSPACE }, { collapsed: !0, prefix: /^.?$/ }, u), r.addBinding({ key: e.keys.DELETE }, { collapsed: !0, suffix: /^.?$/ }, c)),
                            ...
                            return (
                                Array.isArray(this.tagName)
                                    ? ("string" == typeof t && ((t = t.toUpperCase()), parseInt(t).toString() === t && (t = parseInt(t))),
                                      (e = "number" == typeof t ? document.createElement(this.tagName[t - 1]) : this.tagName.indexOf(t) > -1 ? document.createElement(t) : document.createElement(this.tagName[0])))
                                    ...
                                    if (!this.selection.composing && null != this.parent) {
                                        ...
                                        if (this.textNode.data !== e.CONTENTS) {
                                            ...
                                            this.next instanceof p.default
                                                ? ((r = this.next.domNode), this.next.insertAt(0, s), (this.textNode.data = e.CONTENTS))
                                                : ((this.textNode.data = s), this.parent.insertBefore(f.default.create(this.textNode), this), (this.textNode = document.createTextNode(e.CONTENTS)), this.domNode.appendChild(this.textNode));
                                        }
                                    ...
                                    if (t === this.leftGuard)
                                        ...
                                        t === this.rightGuard &&
                                            (this.next instanceof h.default
                                                ...
                                                : ((n = document.createTextNode(r)), this.parent.insertBefore(c.default.create(n), this.next), (e = { startNode: n, startOffset: r.length })));
                                    return (t.data = p), e;
                                },
                            },
                            {
                        ...
                        o(t, [
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    (this.root.style.left = 16 + "px"), (this.root.style.top = n + "px"), this.root.classList.remove("ql-flip");
                                    ...
                                    e.addEventListener("change", function () {
                                        if (null != e.files && null != e.files[0]) {
                                            ...
                                            (n.onload = function (n) {
                                                ...
                                                t.quill.updateContents(new d.default().retain(r.index).delete(r.length).insert({ image: n.target.result }), v.default.sources.USER),
                            ...
                            value: function () {
                                ...
                                switch (this.root.getAttribute("data-mode")) {
                                    case "link":
                                        ...
                                        this.linkRange ? (this.quill.formatText(this.linkRange, "link", t, v.default.sources.USER), delete this.linkRange) : (this.restoreFocus(), this.quill.format("link", t, v.default.sources.USER)),
                                    ...
                                    case "formula":
                                        ...
                                        if (null != n) {
                                            ...
                                            this.quill.insertEmbed(r, this.root.getAttribute("data-mode"), t, v.default.sources.USER),
                                                "formula" === this.root.getAttribute("data-mode") && this.quill.insertText(r + 1, " ", v.default.sources.USER),
                ...
                return (
                    ...
                    (t.prototype.insertBefore = function (t, e) {
                        t &&
                            ((t.next = e),
                            null != e
                                ? ((t.prev = e.prev), null != e.prev && (e.prev.next = t), (e.prev = t), e === this.head && (this.head = t))
                                : null != this.tail
                        ...
                        case v:
                            r + o > 1
                                ? (0 !== r &&
                                      0 !== o &&
                                      ((e = l(s, i)),
                                      0 !== e && (n - r - o > 0 && t[n - r - o - 1][0] == v ? (t[n - r - o - 1][1] += s.substring(0, e)) : (t.splice(0, 0, [v, s.substring(0, e)]), n++), (s = s.substring(e)), (i = i.substring(e))),
                                      0 !== (e = a(s, i)) && ((t[n][1] = s.substring(s.length - e) + t[n][1]), (s = s.substring(0, s.length - e)), (i = i.substring(0, i.length - e)))),
                                  0 === r ? t.splice(n - o, r + o, [y, s]) : 0 === o ? t.splice(n - r, r + o, [d, i]) : t.splice(n - r - o, r + o, [d, i], [y, s]),
                ...
                for (n = 1; n < t.length - 1; )
                    t[n - 1][0] == v &&
                        ...
                        (t[n][1].substring(t[n][1].length - t[n - 1][1].length) == t[n - 1][1]
                            ? ((t[n][1] = t[n - 1][1] + t[n][1].substring(0, t[n][1].length - t[n - 1][1].length)), (t[n + 1][1] = t[n - 1][1] + t[n + 1][1]), t.splice(n - 1, 1), (c = !0))
                            : t[n][1].substring(0, t[n + 1][1].length) == t[n + 1][1] && ((t[n - 1][1] += t[n + 1][1]), (t[n][1] = t[n][1].substring(t[n + 1][1].length) + t[n + 1][1]), t.splice(n + 1, 1), (c = !0))),
                        n++;
                c && u(t);
            }
            function c(t, e) {
                ...
                return t.reduce(function (t, e) {
                    ...
                    if (
                        (null == e.attributes ||
                            ...
                            ((e = (0, N.default)(e)), e.attributes.list ? (e.attributes.list = "ordered") : ((e.attributes.list = "bullet"), delete e.attributes.bullet)),
                    ...
                    n
                        ...
                        .forEach(function (e) {
                            ...
                            (null != n && ((i[n.attrName] = n.value(t)), i[n.attrName])) ||
                                ...
                                null == (n = X[e]) || (n.attrName !== e && n.keyName !== e) || ((n = X[e]), (i[n.attrName] = n.value(t) || void 0)));
                        }),
                    ...
                    return (
                        ...
                        l(e, [
                            ...
                            },
                            {
                                ...
                                value: function (t, n) {
                                    return (
                                        a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "canAdd", this).call(this, t, n) ||
                                        a(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "canAdd", this).call(this, t, parseInt(n))
                                    );
                                },
                            },
                            {
                                    ...
                                    value: function (t, n) {
                                        return (
                                            ...
                                            t === this.parent.statics.blotName
                                                ...
                                                : (this.parent.unwrap(), u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "replaceWith", this).call(this, t, n))
                                        );
                                    },
                                },
                            ],
        ...
        function (t, e, n) {
            ...
            (_.TEMPLATE = [
                ...
                '<input type="text" data-formula="e=mc^2" data-link="Enter link url" data-video="Embed URL">',
                '<a class="ql-close"></a>',
                "</div>",
            ].join("")),
                (e.BubbleTooltip = _),
