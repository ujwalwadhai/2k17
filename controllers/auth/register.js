...
const register = async (req, res) => {
  ...
  try {
    ...
    await user.save();
    await checkAndAwardBadges(user._id, 'new-account');
    ...
    await sendMail('user_registered', adminEmails, { name: user.name, email, username: user.username, totalUsers, verifiedUsers});
